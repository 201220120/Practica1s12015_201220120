...
public class agregarPlanta extends javax.swing.JFrame {
    ...
    public agregarPlanta(String Planta, String nombre, int plantas, nodo nodoUsuarios, nodoPlanta catalogo,String nom) {
        this.patch = Planta;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new agregarPlanta("", "", 0, null, null,"").setVisible(true);
            }
        });
    }
