...
public class ModificarPlanta extends javax.swing.JFrame {
    ...
    nodoPlanta catalogo;
    String nom;
    nodoPlanta nodoPlantaDatos;
int puntos = 0;
String tipo="Disparo";
    public ModificarPlanta(String Planta, String nombre, int plantas, nodo nodoUsuarios, nodoPlanta catalogo, String nom, int puntos, String tipo) {
        this.patch = Planta;
        ...
        this.setTitle("Modificar Planta");
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        if (!(txtNombre.getText().equals("") || txtRuta.getText().equals("") || (int) txtVida.getValue() < 0)) {
            ...
            framePlantas frame = new framePlantas(nick, plantas, nodoUsuarios, nodoCatalogo);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarPlanta("", "", 0, null, null, "",0, "").setVisible(true);
            }
        });
    }
