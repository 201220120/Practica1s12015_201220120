 ...
 * @author Dark
 */
public class matrizTableroPrincipal extends JPanel {
    ...
    public matrizTableroPrincipal(int filas, int columnas) {
        // JOptionPane.showMessageDialog(null, filas+"  "+columnas);
        fila = filas;
        columna = columnas;
        ...
        for (int f = 0; f < fila; f++) {
            for (int c = 0; c < columna; c++) {
                this.setLayout(new GridLayout(fila, columna, 0, 0));
