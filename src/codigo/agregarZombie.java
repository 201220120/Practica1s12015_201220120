...
public class agregarZombie extends javax.swing.JFrame {
    ...
    public agregarZombie(String Planta, String nombre, int plantas, nodo nodoUsuarios, nodoPlanta catalogo, String nom) {
        this.patch = Planta;
    ...
    private void initComponents() {
        ...
        btnAgregar.setText("Agregar Planta");
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        if (!(txtNombre.getText().equals("") || txtRuta.getText().equals("") || (int) txtVida.getValue() < 1)) {

            nodoZombie aux = new nodoZombie();
            aux.Nombre = txtNombre.getText();
            aux.ataque = (txtTipo.getSelectedItem().toString());
            aux.puntos = ((int) txtVida.getValue());
            aux.imagen = txtRuta.getText();
            ...
            frameZombies frame = new frameZombies(nick, plantas, nodoUsuarios, nodoCatalogo, nodoPlant);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new agregarZombie("", "", 0, null, null, "").setVisible(true);
            }
        });
    }
